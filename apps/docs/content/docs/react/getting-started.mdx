...
## (optional) Install the AutoForm Agent Skill
...
<ModeTab
  mode="cli"
  command="skills add https://github.com/adityacodepublic/autoform/tree/acp-package/skills --skill autoform"
/>
...
<ModeTab
  mode="cli"
  command="shadcn@latest add https://raw.githubusercontent.com/adityacodepublic/autoform/refs/heads/acp-package/packages/shadcn/registry/autoform.json"
/>
