...
`fieldConfig` helps you customize individual form fields. Use it to set labels, descriptions, input props, field ordering, field-type overrides, and per-field wrappers. See the [`fieldConfig` API](/docs/react/api#fieldconfig) for available props.
...
import type { FieldTypes } from "@dual-autoform/mui/react-hook-form"; // use your UI adapter
...
<ModeTab
  mode="cli"
  command="shadcn@latest add https://raw.githubusercontent.com/adityacodepublic/autoform/refs/heads/tanstack-form-integration/packages/shadcn/registry/autoform-react-source-rhf.json"
/>
